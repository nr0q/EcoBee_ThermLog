<?php
    ...
    //
    // Version ThermLog.php v0.4
    //
    //
    
    $PAGE_TITLE="EcoBee ThermLog v0.4 by M. Chambers";
...
<body class="mainPage">
<button type="button" id="Menu">Calendar</button>
<button type="button" id="Table">Table</button>
<button type="button" id="Chart">Chart</button>
<?php
